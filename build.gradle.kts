...
dependencies {
    ...
    deobfCompile("malisiscore:malisiscore:1.11.2:$malisisCoreVersion") {
        isTransitive = false
    }
    ...
    if (gradle.includedBuilds.any { it.name == "CubicChunks" }) {
        implementation("io.github.opencubicchunks:cubicchunks-api:1.11.2-0.0-SNAPSHOT")
        runtime("io.github.opencubicchunks:cubicchunks:1.11.2-0.0-SNAPSHOT")
    } else {
